...
export const markdownComponents: Components = {
  ...
  tr: ({ children, node }) => {
    ...
    return (
      <tr className={!isHeader ? "even:bg-gray-50" : ""}>
        {children}
      </tr>
    );
  },
  ...
  h1: ({ children }) => (
    <h1 className="font-bold text-base my-2.5 leading-tight first:mt-0">
      {children}
    </h1>
  ),
  h2: ({ children }) => (
    <h2 className="font-bold text-sm my-2 leading-tight first:mt-0">
      {children}
    </h2>
  ),
  h3: ({ children }) => (
    <h3 className="font-bold text-sm my-1.5 leading-tight first:mt-0">
      {children}
    </h3>
  ),
  h4: ({ children }) => (
    <h4 className="font-bold text-xs my-1 leading-tight first:mt-0">
      {children}
    </h4>
  ),
  p: ({ children }) => (
  ...
  hr: ({ }) => (
    <hr className="border-none border-t border-hub-gray-3 my-2" />
  ),
  strong: ({ children }) => (
